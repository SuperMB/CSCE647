...
namespace Project10
{
    class IrridescentPokeball : Shape
    {
        public IrridescentPokeball(Point center, double radius, Vector upVector, Vector outVector, ImageData texture, ImageData normalMapTop, ImageData normalMapBottom, bool normalPokeball = false)
        {
        ...
        public Color GetColor(Point point, Vector normalVector, Vector ray)
        {
            ...
            Color color = GetIrridescent(normalVector, ray);
            return color;
        }
        ...
        public ReturnData Intersection(Point point, Vector ray)
        {
            ...
            if (sphereReturnData != null)
            {
                ...
                returnData.Add(new ReturnData
                {
                    ...
                    NonIntersectingShapes = new List<Shape> { Sphere , Dot }
                });
            }
