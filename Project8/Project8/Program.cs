...
namespace Project8
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Point pokeballCenter = new Point(-1100, -700, -500);
            Vector pokeballUpVector = new Vector(0, 1, 0);
            Pokeball pokeball = new Pokeball(
                pokeballCenter,
                300,
                pokeballUpVector,
                (cameraPoint - pokeballCenter).UnitVector(),
                MasterBallTexture,
                Smooth,
                Smooth,
                true
            ...
            Point reflectiveCenter = new Point(400, -700, 0);
            Vector reflectiveUpVector = new Vector(0, 1, 0);
            Vector reflectiveOutVector = new Vector(3, -1, 4).UnitVector();
            //Vector reflectiveOutVector = (cameraPoint - reflectiveCenter).UnitVector();
            ReflectivePokeball reflectivePokeball = new ReflectivePokeball(
                reflectiveCenter,
                300,
                reflectiveUpVector,
                reflectiveOutVector,
            ...
            _shapes.Add(reflectivePokeball);
            _intersectingShapes.Add(reflectivePokeball.Sphere);
            _intersectingShapes.Add(reflectivePokeball.Dot);



            ReflectiveSquare reflectiveSquare = new ReflectiveSquare(
            ...
            _shapes.Add(reflectiveSquare);
            _intersectingShapes.Add(reflectiveSquare);
