...
namespace Project5
{
    class Plane : Shape
    {
        public Plane(Point point, Vector normalVector, Vector upVector, ImageData wallpaper, ImageData normalMap)
        {
            ...
            ColorMatrix.IgnoreSpecularIntensity = false;
            ColorMatrix.IgnoreSpotlightIntensity = false;
            Wallpaper = wallpaper;
            NormalMap = normalMap;
            UseNormalMap = true;
        }
        ...
        public ColorMatrix GetColorMatrix(Point2D point)
        {
            ...
            ColorMatrix pixel = Wallpaper.GetPixel(point.X, point.Y);
            return pixel;
        }
        ...
        private Vector GetNormalVector(Point2D point)
        {
            ...
            ColorMatrix pixel = NormalMap.GetPixel(point.X, point.Y);
        ...
        public ReturnData Intersection(Point point, Vector ray)
        {
            ...
            {
                Point = result,
                ColorMatrix = GetColorMatrix(point2D),
