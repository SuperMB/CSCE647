...
namespace Project11
{
    class ReflectivePokeball : Shape
    {
        public ReflectivePokeball(Point center, double radius, Vector upVector, Vector outVector, ImageData texture, ImageData normalMapTop, ImageData normalMapBottom, List<Shape> shapes)
        {
            ...
            if (sphereReturnData != null)
            {
                ...
                else
                {
                    ...
                    if (reflectReturnData != null)
                    {
                        ...
                        color.Omega /= factor;
                        color += Reflection;// GetIrridescent(reflectReturnData.NormalVector, ray);
                        returnData.Add(new ReturnData
                        {
                            Point = sphereIntersection,
        ...
        public static Color Reflection = new Color(2, 0, 0, 2);
    }
}